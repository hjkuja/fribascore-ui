...
export default function Welcome() {
    return (
        <div>
            <h1>Welcome to the FribaScore app.</h1>
            <p>
                This is the FribaScore app.
            </p>
            <p>
                Go ahead and start a round by choosing a course.
            </p>
            <Link to="/courses" className="welcome-courses-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="welcome-courses-icon" aria-hidden>
